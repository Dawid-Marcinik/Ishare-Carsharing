...
/*   var patronNombre = /^[a-zA-ZáéíóúÁÉÍÓÚ çÇñÑ-]{3,30}$/;
  ...
  console.log(form);
    ...
    console.log(validarU,validarC,validarL,validarD,validarCP,validarT,validarE,validarDN,validarN,validarA,validarF);


  
    if (validarU && validarC && validarL && validarD && validarCP && validarT && validarE && validarDN && validarN && validarA && validarF)  {
