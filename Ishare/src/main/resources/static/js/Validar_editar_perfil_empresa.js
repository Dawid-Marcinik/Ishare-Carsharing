...
/*   var patronNombre = /^[a-zA-ZáéíóúÁÉÍÓÚ çÇñÑ-]{3,30}$/;
  ...
  function validar(form) {
   console.log(form);
    ...
    console.log(validarU,validarC,validarL,validarD,validarCP,validarT,validarE,validarCi,validarR);


  
    if (validarU && validarC && validarL && validarD && validarCP && validarT && validarE && validarCi && validarR)  {
